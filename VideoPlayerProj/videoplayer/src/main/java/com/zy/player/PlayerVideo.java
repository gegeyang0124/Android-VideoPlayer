 ...
 * On 2019/1/5 22:09
 */
public class PlayerVideo extends Player {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(PlayerActionUser.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (PlayerMgr.getFirstFloor().currentScreen == Player.SCREEN_WINDOW_LIST) {
            ...
            onStatePreparing();
            onEvent(PlayerAction.ON_CLICK_START_ERROR);
        }
    }
